...
def contact(request):
    if request.method=="POST":
        ...
        msgg="Message Send Succesfully"
    return render(request,'header.html',{'msgg':msgg})
...
def take_appointment(request):    
    if request.method=="POST":
        ...
        return render(request,'take-appointment.html',{'msg':msg})
    else:
        return render(request,'take-appointment.html')
    

def dr_view_appointment(request):    
    view_appointment=Appointment.objects.all()
    return render(request,'dr-view-appointment.html',{'view_appointment':view_appointment})